...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-07-15 08:55`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/917dfc58-a626-455c-95eb-d5934c433f5e.git
$ cd 917dfc58-a626-455c-95eb-d5934c433f5e
```
